...
alphasparseStatus_t transpose_csr(const I *A, I **B)
{

    I *mat = (I*)alpha_malloc(sizeof(I));
    *B = mat;
    ...
    mat->col_indx = (ALPHA_INT*)alpha_memalign((uint64_t)nnz * sizeof(ALPHA_INT), DEFAULT_ALIGNMENT);
    mat->values = (J*)alpha_memalign((uint64_t)nnz * sizeof(J), DEFAULT_ALIGNMENT);
