...
alphasparseStatus_t destroy_s_csr(spmat_csr_s_t *A);
...
// !insert new2coo float before this line
alphasparseStatus_t destroy_d_csr(spmat_csr_d_t *A);
...
alphasparseStatus_t destroy_c_csr(spmat_csr_c_t *A);
...
alphasparseStatus_t destroy_z_csr(spmat_csr_z_t *A);
