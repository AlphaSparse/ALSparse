                    ...
                    int blocksize)
{
  ...
  cudaMalloc((void **)&d_ell_col_inx, mb * max_block_cols * sizeof(int));
  cudaMemcpy(d_ell_col_inx,
             ell_col_inx,
             mb * max_block_cols * sizeof(int),
             cudaMemcpyHostToDevice);
  U *d_ell_values = NULL;
  cudaMalloc((void **)&d_ell_values, m * ell_cols * sizeof(U));
  cudaMemcpy(
      d_ell_values, ell_values, m * ell_cols * sizeof(U), cudaMemcpyHostToDevice);
